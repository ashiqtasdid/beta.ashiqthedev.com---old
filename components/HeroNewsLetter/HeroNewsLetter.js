        ...
        <div className="container col-xl-10 col-xxl-8 px-4 py-5">
            <div className="row align-items-center g-lg-5 py-5">
                ...
                <div className='col-md-10 mx-auto col-lg-5' id="revue-embed">
                    <form action="https://www.getrevue.co/profile/AshiqTheDev/add_subscriber" method="post" id="revue-form" name="revue-form" target="_blank" rel="noreferrer" className='p-4 p-md-5 border rounded-3 bg-light'>
                        ...
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="member_last_name">Last name <span classNameName="optional">(Optional)</span></label>
                        </div>
